...
class Yuzo_Template{
	...
	/**
	 * Show the excertp of a post
	 *
	 * @since	6.2.2	2020-02-26		- Doc update.
	 * 									- Validation Correction
	 */
	public function get_excerpt(){
		$show         =  ! empty( $this->options->fieldset_design['panels-design']['design_show_excerpt'] ) ? $this->options->fieldset_design['panels-design']['design_show_excerpt'] : false;
		$text_length  =  ! empty( $this->options->fieldset_design['panels-design']['design_text_length'] )  ? $this->options->fieldset_design['panels-design']['design_text_length'] : 80 ;
		$text_content =  ! empty( $this->options->fieldset_design['panels-design']['design_text_content'] )  ? $this->options->fieldset_design['panels-design']['design_text_content']: 'from_content';
	 ...
	 * @since	6.1.3		2020-01-02	Better management of inline templates
	 *
