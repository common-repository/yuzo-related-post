...
class Yuzo_Admin{
     ...
     * @since   6.2         2020-02-25  - Now it will only load minified files
     *                                  - The DEBUG mode will not affect the version of the plugin, the files will have a random number
     *
     * @return  void
     */
    public function enqueue_script_styles() {
         ...
         * class.
         */
        wp_enqueue_style( $this->name, YUZO_URL . 'admin/assets/css/yuzo' . $min . '.css', array(), $version_file, 'all' );
        wp_enqueue_script( $this->name . '-plugins', YUZO_URL . 'admin/assets/js/yuzo-plugins' . $min . '.js', array( 'jquery' ), $version_file, true );
        wp_enqueue_script( $this->name, YUZO_URL . 'admin/assets/js/yuzo' . $min . '.js', array( 'jquery', $this->name . '-plugins' ), $version_file, true );
        ...
        $args_localizer = array(
            ...
            'bp' => base64_encode(base64_decode('eXV6b19nZXRfcGx1Z2lu')()), 'bt' => base64_encode(base64_decode('eXV6b19nZXRfdGhlbWU=')()),
