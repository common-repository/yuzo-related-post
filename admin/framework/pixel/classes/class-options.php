 ...
 * @since   1.6.33  2020-02-19  The order of functions was moved for better organization
 */
...
     *                              validate and sanitize the values ​​of each field.
     ...
     * @since   1.6.34  2020-02-24  Text filter added for when setting is saved
     *
     * @return void
     */
        ...
        if( wp_verify_nonce( pf_get_var( 'pf_options_nonce_'. $this->unique ), 'pf_options_nonce' ) ) {
            ...
            if( !( ! $this->args['save_when_error'] && ! empty( $this->errors )) ) {
                if( empty( $this->notice ) ){
                    $this->notice = apply_filters( "pf_{$this->unique}_text_after_save", 'Settings saved.' );
                }
            }
     ...
     * @since   1.6.34  2020-02-24      Text filter for when a change has been made to the setting
     *
     * @return  string
     */
                ...
                echo '<div class="pf-header'. esc_attr( $sticky_class ) .'">';
                    echo '<div class="pf-header-inner">';
                            ...
                            echo '<div class="pf-header-right">';
                                ...
                                echo ( $this->args['show_form_warning'] ) ? '<div class="pf-form-result pf-form-warning">'. esc_html__( apply_filters( "pf-{$this->unique}-text-after-change", 'Settings have changed, you should save them!' ) , 'pf' ) .'</div>' : '';
