...
class PF_Field_notice extends PF_classFields {
    ...
    public function render() {
        ...
        $stylecss = ( ! empty( $this->field['stylecss'] ) ) ? ' style="' . $this->field['stylecss'] . '"' : '';

        echo ! empty( $this->field['content'] ) ? '<div ' . $stylecss . ' class="pf-notice pf-notice-'. $style .'">'. $this->field['content'] .'</div>' : '';
