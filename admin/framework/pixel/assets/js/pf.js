...
;(function( $, window, document, undefined ) {
  ...
  $.fn.pf_field_background = function() {
    return this.each( function() {
      $(this).find('.pf--background-image').pf_reload_script();
    });
  };
    ...
    return this.each( function() {
      ...
      $this.on('click', '.pf-icon-add', function( e ) {
        ...
        if( !PF.vars.icon_modal_loaded ) {
          ...
          window.wp.ajax.post( 'pf-get-icons', {
  ...
  // --- Field map ---------------
  $.fn.pf_field_map = function() {
    return this.each( function() {

      if( typeof L === 'undefined' ) { return; }

      var $this         = $(this),
          $map          = $this.find('.pf--map-osm'),
          $search_input = $this.find('.pf--map-search input'),
          $latitude     = $this.find('.pf--latitude'),
          $longitude    = $this.find('.pf--longitude'),
          $zoom         = $this.find('.pf--zoom'),
      ...
      if( ! $search_input.length ) {
        $search_input = $( '[data-depend-id="'+ $this.find('.pf--address-field').data( 'address-field' ) +'"]' );
      }
      ...
      $search_input.autocomplete({
        ...
        create: function (event, ui) {
          $(this).autocomplete('widget').addClass('pf-map-ui-autocomplate');
        }
      });
  ...
  $.fn.pf_field_media = function() {
    return this.each( function() {
      ...
      var $this            = $(this),
          ...
          $auto_attributes = ( $this.hasClass('pf-assign-field-background') ) ? $this.closest('.pf-field-background').find('.pf--auto-attributes') : false,
          wp_media_frame;
      ...
      $upload_button.on('click', function( e ) {
        ...
        wp_media_frame.on( 'select', function() {
          ...
          if( $auto_attributes ) {
            $auto_attributes.removeClass('pf--attributes-hidden');
          }
      ...
      $remove_button.on('click', function( e ) {
        ...
        if( $auto_attributes ) {
          $auto_attributes.addClass('pf--attributes-hidden');
        }
        ...
        if( !flooding ) {
          ...
          if( $this.hasClass('pf-save-ajax') ) {
            ...
            .done( function( response ) {
              ...
              PF.vars.form_modified = false;
              PF.vars.$form_warning.hide();
  ...
  // --- Option Framework ---------------
  $.fn.pf_options = function() {
    return this.each( function() {

      var $this         = $(this),
          $content      = $this.find('.pf-content'),
          $form_success = $this.find('.pf-form-success'),
          $form_warning = $this.find('.pf-form-warning'),
          $save_button  = $this.find('.pf-header .pf-save');

      PF.vars.$form_warning = $form_warning;

      // Shows a message white leaving theme options without saving
      if( $form_warning.length ) {

        window.onbeforeunload = function() {
          return ( PF.vars.form_modified ) ? true : undefined;
        };

        $content.on('change keypress', ':input', function() {
          if( !PF.vars.form_modified ) {
            $form_success.hide();
            $form_warning.fadeIn('fast');
            PF.vars.form_modified = true;
          }
        });

      }

      if( $form_success.hasClass('pf-form-show') ) {
        setTimeout( function() {
  ...
  $.fn.pf_reload_script = function( options ) {
    ...
    return this.each( function() {
      ...
      if( !$this.data('inited') ) {
        ...
        // Field Map
        $this.children('.pf-field-map').pf_field_map();
