...
function pf_get_icons() {
    ...
    $sanitize_post = wp_unslash( $_POST );
    array_walk_recursive( $sanitize_post, 'sanitize_text_field' );
...
function pf_export() {
    ...
    // Sanitize request ajax
    $sanitize_get = wp_unslash( $_GET );
    array_walk_recursive( $sanitize_get, 'sanitize_text_field' );
