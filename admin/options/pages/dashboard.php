 ...
 * @since   6.2         2020-02-25      Facebook group button added
 */
/*
|--------------------------------------------------------------------------
| Creation pages
...
<div class="yzp-wrapper">
    ...
    <div class="yzp-body-wrapper">
        <div class="yzp-body">
            <h1>Welcome to the new <span>Yuzo <span class="yzp-brands-6">6</span>
                Related and List posts</span>
                <a href="http://bit.ly/YuzoDonate4" target="_blank" class="yzp-button-donate button">Donate</a>
                <a href="http://bit.ly/2vdnziy" target="_blank" class="yzp-button-fb-group button button-primary">Facebook Group</a>
            </h1>
                    ...
                    <div class="yzp-changelog-wrap">
                        <div class="yzp-changelog">
                            <ul class="yzp-changelog-item">
                                <li class="yzp-changelog-li"><span class="version"->6.2.2</span> <span class="date">- 2020-02-26</span></li>

                                <li class="yzp-changelog-li"><span class="yzp--type new">RELEASE</span>Now all post type that you enable for Yuzo will have the column to filter number of views [PRO]</li>

                                <li class="yzp-changelog-li"><span class="yzp--type add">Newfeatures</span>A class in body is added to know if it is Free version or Pro version, this serves to classify styles and other purposes.</li>

                                <li class="yzp-changelog-li"><span class="yzp--type improve">Improve</span>Change of labels in the text of the Yuzo algorithms.</li>

                                <li class="yzp-changelog-li"><span class="yzp--type fixed">Bugfixes</span>Correction in the validation whether or not it shows an excerpt.</li>
                                <li class="yzp-changelog-li"><span class="yzp--type fixed">Bugfixes</span>Recursive array in 2 lines to avoid Notice PHP.</li>
                                <li class="yzp-changelog-li"><span class="yzp--type fixed">Bugfixes</span>Excerpt validation was sending errors.</li>
                            </ul>
                            <ul class="yzp-changelog-item">
                                <li class="yzp-changelog-li"><span class="version"->6.2.1</span> <span class="date">- 2020-02-26</span></li>

                                <li class="yzp-changelog-li"><span class="yzp--type improve">Improve</span>In DEBUG mode Yuzo frontend now does it with the minified files.</li>
                                <li class="yzp-changelog-li"><span class="yzp--type improve">Improve</span>Now the total number of visits in the frontend is shown if the counters are cut.</li>
                                <li class="yzp-changelog-li"><span class="yzp--type fixed">Bugfixes</span>EVAL function was removed to prevent other security plugin from detecting any anomaly.</li>
                            </ul>
                            <ul class="yzp-changelog-item">
                                <li class="yzp-changelog-li"><span class="version"->6.2</span> <span class="date">- 2020-02-26</span></li>

                                <li class="yzp-changelog-li"><span class="yzp--type awesome">🦄 Awesome</span>Yuzo has a new icon to represent the number of views in the posts, it is a special flame.</li>
                                <li class="yzp-changelog-li"><span class="yzp--type update">Update</span>Framework <code>Pixel</code> was updated to the version <code>1.6.34</code>.</li>

                                <li class="yzp-changelog-li"><span class="yzp--type new">RELEASE</span>New style to see the number of visits within the Gutenberg editor.</li>
                                <li class="yzp-changelog-li"><span class="yzp--type new">RELEASE</span>New icons (5 styles) to show the number of views of the post. Now you can choose in colors and gray scale. [PRO]</li>
                                <li class="yzp-changelog-li"><span class="yzp--type new">RELEASE</span>Conditional to show the number of visits in a post as long as it is greater than the number you place, This makes it attractive to not show the number of views for post with little scope, this makes it attractive for the user to see the number of visits only for post with X number.[PRO]</li>
                                <li class="yzp-changelog-li"><span class="yzp--type new">RELEASE</span>Now you can save the general settings just by pressing <code> CONTROL + S </code>.</li>
                                <li class="yzp-changelog-li"><span class="yzp--type new">RELEASE</span>Option that allows not to repeat the posts in all Yuzo within the same page.</li>

                                <li class="yzp-changelog-li"><span class="yzp--type add">Newfeatures</span>The FB GROUP button was added so they can join the Yuzo community.</li>
                                <li class="yzp-changelog-li"><span class="yzp--type add">Newfeatures</span>When you activate the DEBUG mode, a message appears in the ADMIN BAR that you have it active, this to notify.</li>

                                <li class="yzp-changelog-li"><span class="yzp--type improve">Improve</span>The name was changed to show the yuzo list of 'Related | List 'is now' All Yuzo 'by standard.</li>
                                <li class="yzp-changelog-li"><span class="yzp--type improve">Improve</span>When installing the plugin the first page you will see is the 'about'.</li>
                                <li class="yzp-changelog-li"><span class="yzp--type improve">Improve</span>When you cut the number of views you can see the exact total of visits by hovering over the number cut (only Admin at the moment).[PRO]</li>

                                <li class="yzp-changelog-li"><span class="yzp--type fixed">Bugfixes</span>When you have active the <code> Rank Math </code> plugin, the preview of Yuzo Builder in the administration was not visible, this was corrected.</li>
                                <li class="yzp-changelog-li"><span class="yzp--type fixed">Bugfixes</span>Now in debug mode it does not alter the Yuzo version number, now for this a random number only put in the version of the css and js files. This fixes that the version number is not changed.</li>
                                <li class="yzp-changelog-li"><span class="yzp--type fixed">Bugfixes</span>There are some Themes that within the content add a 'before' or 'after' on the UL label, this caused the grid template to overflow, this was corrected.</li>
                                <li class="yzp-changelog-li"><span class="yzp--type fixed">Bugfixes</span>Validate that if you have less than 30 posts, only the tag relationship Yuzo is activated.</li>
                            </ul>
                            <ul class="yzp-changelog-item">
...
<span class="tiptext"><img src="'. $imagen[rand(0,9)] .'" />Show us some 💙 by writing your review</span>
</div>';
