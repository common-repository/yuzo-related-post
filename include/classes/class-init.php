...
         * of the plugin, these are environment variables
    ...
    */
     ...
     * @since   6.2         2020-02-25  - The hooks were added for debug mode, validate if you already saw the 'about' page.
     *                                  - The filter was added to update the text when saving in the Setting
     * @since   6.2.2       2020-02-26  Filter added admin_body_class
     * @access  private
     */
    private function define_admin_hooks() {
        ...
        $this->loader->add_action( 'admin_bar_menu',  $this->admin_custom, 'debug_mode_adminbar', 151 );
        $this->loader->add_action( 'in_admin_header',  $this->admin_custom, 'yuzo_header_in_cpt', 150 );
        $this->loader->add_action( 'in_admin_header',  $this->admin_custom, 'validate_if_visited_aboutpage', 150 );
        ...
        $this->loader->add_filter( "pf_yuzo-setting_text_after_save", $this->admin_custom, 'change_text_after_save' );
        $this->loader->add_filter( 'plugin_action_links_'.YUZO_BASENAME, $this->admin_custom, 'actionLinks' );
        $this->loader->add_filter( 'admin_body_class', $this->admin_custom, 'admin_body_class' );

        //add_filter("pf_yuzo-setting_text_after_save",'YUZO\\Admin\\Yuzo_AdminCustom\\change_text_after_save');
