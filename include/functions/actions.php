 ...
 * @since   6.0.9.8     2019-08-28  New functionality to calculate the CPC and save this data.
 * @since   6.1.3       2020-01-02  Sanitize recursive validation for security
 * @since   6.2.2       2020-02-26  Recursive array in 2 lines to avoid Notice PHP.
 * @return  json|array
 */
 ...
 *
 * @since   6.0     2019-05-03  Release
 * @since   6.0.8.5 2019-07-19  Change name var count to '$timestamp_views'
 * @since   6.0.9   2019-07-21  Improvements when counting a real visit
 * @since   6.0.9.2 2019-07-24  Adjustments were made to the counter algorithm
 * @since   6.0.9.8 2019-08-28  Minimum settings
 * @since   6.1.3   2020-01-02  Sanitize recursive validation for security
 * @return  json|array
 */
